...
# # GET "/auth/docusign/callback?error=access_denied&
# #   error_message=The%20user%20did%20not%20consent%20to%20connecting%20the%20application.&state=
...
#     strategy.options[:authorize_params].scope = "signature extended signature openid click.manage click.send"
#     # "content spring_read spring_write spring_write group_read permission_read user_read user_write account_read
#     # domain_read identity_provider_read dtr.rooms.read dtr.rooms.write dtr.documents.read dtr.documents.write dtr.profile.read
#     # dtr.profile.write dtr.company.read dtr.company.write room_forms notary_write notary_read"
#   }
# end
